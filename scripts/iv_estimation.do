capture log close
log using geo_educ_earn.log, replace

////////////////////////////////////////////////////////////////////////////////
//
// <FILE> iv_estimation.do
...
// set locals: all, men, women
local conditions 0 1 2

// set locals: years
local yearlist 2007 2008 2009 2010

// set locals: outcome variables
local yvars lyinc lwage

// set locals: primary independent variable
local x ccol

// set locals: control variables
local controls asvab black hispanic multiracial female south smsa medinc i.quarter
...
save ${datdir}geo_result, replace
...
foreach cond of local conditions{
    ...
    if `cond' == 0 {
        ...
        di "===================================================================="
        di ""
        di "Estimates for All Respondents"
        di ""
        di "===================================================================="
        di ""
        di ""
        ...
        di "===================================================================="
        di ""
        di "Estimates for Male Respondents"
        di ""
        di "===================================================================="
        di ""
        di ""
        ...
        di "===================================================================="
        di ""
        di "Estimates for Female Respondents"
        di ""
        di "===================================================================="
        di ""
        di ""
    ...
    foreach y of local yvars {
        ...
        forvalues zz = 1/`zlength' {
            ...
            foreach year of local yearlist {
                ...
                // subsetting data for each year so preserve (R is way better)
                preserve
                keep if year == `year'
        ...
        drop _all
        svmat `y'_fsmat
        outsheet using ${outdir}`y'_`sex'_fsmat.csv, c replace

        drop _all
        svmat `y'_ssmat
        outsheet using ${outdir}`y'_`sex'_ssmat.csv, c replace
